...
function addUser($con, $username, $firstname, $lastname, $email, $password) {
...
function updateUser($con, $username, $firstname, $lastname, $email, $password) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        return "Error updating user: " . mysqli_error($con);
    }
}

function removeUser($con, $id) {
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    if (isset($_POST['add_user'])) {
        ...
        $result = addUser($con, $username, $firstname, $lastname, $email, $password);
        
        if ($result === "User added successfully!") {
            header("Location: " . $_SERVER['PHP_SELF'] . "?add=success&message=User added successfully!");
            exit();
        } else {
        ...
        $result = updateUser($con, $username, $firstname, $lastname, $email, $password);

        if ($result === "User updated successfully!") {
            header("Location: " . $_SERVER['PHP_SELF'] . "?update=success&message=User updated successfully!");
            exit();
        } else {
            header("Location: " . $_SERVER['PHP_SELF'] . "?update=fail&message=User was not updated successfully.");
            exit();
        }
        ...
        if (!empty($user_id)) {
            ...
            if (mysqli_num_rows($check_result) > 0) {
                if (removeUser($con, $user_id)) {
                    header("Location: " . $_SERVER['PHP_SELF'] . "?remove=success&message=User removed successfully.");
                    exit();
                } else {
                    header("Location: " . $_SERVER['PHP_SELF'] . "?remove=fail&message=User was not removed successfully.");
                    exit();
                }
            } else {
                header("Location: " . $_SERVER['PHP_SELF'] . "?remove=fail&message=User Id was not found.");
                exit();
            }
        } else {
...
<body>
    ...
    <main>
        ...
        <div class="buttons">
            ...
            <button id="update_user_btn">Update User</button>
            <button id="remove_user_btn">Remove User</button>
        </div>
        ...
        <div class="user_box">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="add_container">
                    ...
                    <div>
                        <label for="update">Update User</label><br>
        ...
        <div class="user_box">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="add_container">
                    ...
                    <div>
                        <label for="update">Remove User</label><br>
